...
describe('Recipes', function() {
    ...
    it('should add recipes on POST', function() {
        //created variable for array of ingredients 
        const ingredientList = ['corn', 'tomatoes', 'beans', 'beef'];
        const newRecipe = {name: 'chili', ingredients: ingredientList};
        return chai
            .request(app)
            .post('/recipes')
            .send(newRecipe)
            .then(function(res) {
                ...
                expect(res.body).include.keys('id', 'name', 'ingredients');
